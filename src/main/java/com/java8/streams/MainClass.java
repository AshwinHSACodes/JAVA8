...
public class MainClass {
	...
	private static void countStringLenghtMoreThanGivenNumber(int length) {
		...
		System.out.println("In stringListOne count : "
				+ CountStringLenghtMoreThanGivenNumber.countStringLenghtMoreThanGivenNumber(stringListOne, length));
		System.out.println("In stringListOne count : "
				+ CountStringLenghtMoreThanGivenNumber.countStringLenghtMoreThanGivenNumber(stringListTwo, length));
	}
	...
	private static void createListWithMoreThanSpecifiedNumberOfCharecters(int length) {
		...
		List<String> resultList = CreateListWithMoreThanSpecifiedNumberOfCharecters
				.createListWithMoreThanSpecifiedNumberOfCharecters(originalList, length);
		System.out.println(originalList);
		System.out.println(resultList);
	...
	private static void createListOfSquaresOfDistinctNumbers() {
		...
		List<Integer> resultList = CreateListOfSquaresOfDistinctNumbers
				.createListOfSquaresOfDistinctNumbers(listOfIntegers);
